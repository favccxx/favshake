...
.login-form:before {
    ...
    background:#fff url("assets/imgs/profilepicture.jpg") no-repeat 2px 2px;
}
.not-registered {
    position:absolute;
	...
	<form action="" method="post" class="login-form">
		<div class="username">
			<input type="text" name="username"
				placeholder="emma.watson@gmail.com" autocomplete="on" /> <span
				class="user-icon icon">u</span>
		</div>
		<div class="password">
			<input type="password" name="password" placeholder="*******" /> <span
		...
		<div class="account-control">
			...
			<p class="not-registered">仅以支付宝形式发放，每日一次，第一次为准。<a href="http://www.favdeal.cn">哎咦网赞助</a></p>
		</div>
	</form>
</body>
</html>